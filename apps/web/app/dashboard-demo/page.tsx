        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link href="/auth/signin-demo" className="text-blue-600 hover:underline">
                        Fazer login
                    </Link>
                </div>
            </div>
                ...
                <div className="grid gap-6">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            ...
                            <p className="text-blue-700">
                                ...
                                O erro "Server error" foi resolvido usando um sistema de login alternativo que não 
                                depende do NextAuth.
                            </p>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <ul className="list-disc list-inside text-gray-600 space-y-2">
                            ...
                            <li><strong>Autenticação:</strong> NextAuth.js + sistema de demonstração</li>
