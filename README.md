# SkillShare Hub - Complete Project Documentation

## 🎯 Project Overview

SkillShare Hub is a comprehensive workshop and course management platform built with modern technologies. It's a full-stack application that allows users to create, manage, and participate in educational workshops.

### 🚀 Live Deployments

- **Production API**: https://skillsharehub-production.up.railway.app
...
This is a **monorepo** workspace managed with **pnpm** containing:
